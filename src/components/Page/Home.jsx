        ...
        <>
            <div className='relative overflow-hidden'>
                <div className=' max-w-[85vw] mx-auto' >
                    ...
                    <div className='flex items-center justify-center absolute top-5 md:left-5 md:right-0 lg:right-0'>
                    ...
                    <div className="flex justify-center items-center mt-6 ">
                        ...
                        <span className='hidden md:flex lg:flex sm:flex '>Page {currentPage} of {totalPages}</span>
                        <button
